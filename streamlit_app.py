...
if language == "ENG":
    with st.expander("**I'm driving**"):
        ...
        """
        st.markdown("""
        <iframe width=700 height=600 src="https://docs.google.com/spreadsheets/d/18m0ynbyI23b6Ac3nsWZO7NpxU6eVmFNSXFxOKpWsWLA/edit?usp=sharing?widget=true&amp;headers=false""></iframe>
        """,unsafe_allow_html=True)
